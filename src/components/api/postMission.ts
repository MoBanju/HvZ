...
export function PostMissionInGameAction(game_id: number, mission: IPostMissionRequest, sideEffect: sideEffect): PayloadAction<RequestPayload<IParams, IMission>> {
    return {
