  ...
  return (
    ...
    <div className="float-end me-5 resp">
      ...
      <div>
        ...
        <h5>
          <ul>
            <li className="m-2 lead">People who are not registered players are not allowed to interfere with gameplay. 
            ...
            <li className="m-2 lead">Almost all players begin the game as humans, and must keep their bite code with them at all times in case a zombie attacks them. 
              If they are tagged, they must surrender their code, and become a zombie after one hour has elapsed.</li>
            <li className="m-2 lead">Zombies must gather and input the the bite code of all humans that they "turn" 
